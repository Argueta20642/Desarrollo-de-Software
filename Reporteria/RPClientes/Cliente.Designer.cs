...
namespace Hotel5taReal.Reporteria.RPClientes {
    ...
    public partial class Cliente : global::System.Data.DataSet {
        ...
        public partial class ReservaDataTable : global::System.Data.TypedTableBase<ReservaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ReservaRow AddReservaRow(string NombreCliente, string ApellidoCliente, decimal Precio, System.DateTime FechaIngreso, int Cod_Reservas) {
...
namespace Hotel5taReal.Reporteria.RPClientes.ClienteTableAdapters {
    ...
    public partial class ReservaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Reserva] WHERE (((@IsNull_NombreCliente = 1 AND [NombreCliente] IS NULL) OR ([NombreCliente] = @Original_NombreCliente)) AND ((@IsNull_ApellidoCliente = 1 AND [ApellidoCliente] IS NULL) OR ([ApellidoCliente] = @Original_ApellidoCliente)) AND ((@IsNull_Precio = 1 AND [Precio] IS NULL) OR ([Precio] = @Original_Precio)) AND ((@IsNull_FechaIngreso = 1 AND [FechaIngreso] IS NULL) OR ([FechaIngreso] = @Original_FechaIngreso)) AND ([Cod_Reservas] = @Original_Cod_Reservas))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Reserva] ([NombreCliente], [ApellidoCliente], [Precio], [FechaIngreso], [Cod_Reservas]) VALUES (@NombreCliente, @ApellidoCliente, @Precio, @FechaIngreso, @Cod_Reservas);
SELECT NombreCliente, ApellidoCliente, Precio, FechaIngreso, Cod_Reservas FROM Reserva WHERE (Cod_Reservas = @Cod_Reservas)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Reserva] SET [NombreCliente] = @NombreCliente, [ApellidoCliente] = @ApellidoCliente, [Precio] = @Precio, [FechaIngreso] = @FechaIngreso, [Cod_Reservas] = @Cod_Reservas WHERE (((@IsNull_NombreCliente = 1 AND [NombreCliente] IS NULL) OR ([NombreCliente] = @Original_NombreCliente)) AND ((@IsNull_ApellidoCliente = 1 AND [ApellidoCliente] IS NULL) OR ([ApellidoCliente] = @Original_ApellidoCliente)) AND ((@IsNull_Precio = 1 AND [Precio] IS NULL) OR ([Precio] = @Original_Precio)) AND ((@IsNull_FechaIngreso = 1 AND [FechaIngreso] IS NULL) OR ([FechaIngreso] = @Original_FechaIngreso)) AND ([Cod_Reservas] = @Original_Cod_Reservas));
SELECT NombreCliente, ApellidoCliente, Precio, FechaIngreso, Cod_Reservas FROM Reserva WHERE (Cod_Reservas = @Cod_Reservas)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        NombreCliente, ApellidoCliente, Precio, FechaIngreso, Cod_Reservas\r" +
                "\nFROM            Reserva";
        ...
        public virtual int Fill(Cliente.ReservaDataTable dataTable) {
        ...
        public virtual Cliente.ReservaDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Cliente.ReservaDataTable dataTable = new Cliente.ReservaDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Cliente.ReservaDataTable dataTable) {
        ...
        public virtual int Delete(string Original_NombreCliente, string Original_ApellidoCliente, global::System.Nullable<decimal> Original_Precio, global::System.Nullable<global::System.DateTime> Original_FechaIngreso, int Original_Cod_Reservas) {
            ...
            if ((Original_FechaIngreso.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[7].Value = ((System.DateTime)(Original_FechaIngreso.Value));
            }
            else {
                this.Adapter.DeleteCommand.Parameters[6].Value = ((object)(1));
                this.Adapter.DeleteCommand.Parameters[7].Value = global::System.DBNull.Value;
            }
            this.Adapter.DeleteCommand.Parameters[8].Value = ((int)(Original_Cod_Reservas));
        ...
        public virtual int Insert(string NombreCliente, string ApellidoCliente, global::System.Nullable<decimal> Precio, global::System.Nullable<global::System.DateTime> FechaIngreso, int Cod_Reservas) {
            ...
            this.Adapter.InsertCommand.Parameters[4].Value = ((int)(Cod_Reservas));
        ...
        public virtual int Update(string NombreCliente, string ApellidoCliente, global::System.Nullable<decimal> Precio, global::System.Nullable<global::System.DateTime> FechaIngreso, int Cod_Reservas, string Original_NombreCliente, string Original_ApellidoCliente, global::System.Nullable<decimal> Original_Precio, global::System.Nullable<global::System.DateTime> Original_FechaIngreso, int Original_Cod_Reservas) {
            if ((NombreCliente == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Cod_Reservas));
            if ((Original_NombreCliente == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[13].Value = ((int)(Original_Cod_Reservas));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string NombreCliente, string ApellidoCliente, global::System.Nullable<decimal> Precio, global::System.Nullable<global::System.DateTime> FechaIngreso, string Original_NombreCliente, string Original_ApellidoCliente, global::System.Nullable<decimal> Original_Precio, global::System.Nullable<global::System.DateTime> Original_FechaIngreso, int Original_Cod_Reservas) {
            return this.Update(NombreCliente, ApellidoCliente, Precio, FechaIngreso, Original_Cod_Reservas, Original_NombreCliente, Original_ApellidoCliente, Original_Precio, Original_FechaIngreso, Original_Cod_Reservas);
        }
    }
