...
namespace Hotel5taReal.Front_End.FrmUser
{
    public partial class FrmRecepcion : Form
    {
        ...
        {
            Abrirformhijo(new FrmHomeUS());

        }

        private void btnReservar_Click(object sender, EventArgs e)
        {
            Abrirformhijo(new FrmAdmin.FrmReservar());
        }

        private void btnHabitaciones_Click(object sender, EventArgs e)
        {
            Abrirformhijo(new FrmAdmin.FrmHabitaciones());
        }
        //---BOTON SALIR----------------------->
        ...
        //---EVENTO  RESIZE DEL FRMUSER----------------------->
        private void FrmRecepcion_Resize(object sender, EventArgs e)
        {
            AdjustForm();
        }
        //---FIN EVENTO  RESIZE DEL FRMUSER----------------------->
