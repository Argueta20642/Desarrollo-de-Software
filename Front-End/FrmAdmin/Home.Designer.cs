...
namespace Hotel5taReal.Front_End.FrmAdmin {
    ...
    public partial class Home : global::System.Data.DataSet {
        ...
        public partial class ProductoDataTable : global::System.Data.TypedTableBase<ProductoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductoRow AddProductoRow(string Nombre_Producto, int Cod_Producto, decimal Precio) {
...
namespace Hotel5taReal.Front_End.FrmAdmin.HomeTableAdapters {
    ...
    public partial class ProductoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Producto] WHERE (((@IsNull_Nombre_Producto = 1 AND [Nombre_Producto] IS NULL) OR ([Nombre_Producto] = @Original_Nombre_Producto)) AND ([Cod_Producto] = @Original_Cod_Producto) AND ((@IsNull_Precio = 1 AND [Precio] IS NULL) OR ([Precio] = @Original_Precio)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Producto] ([Nombre_Producto], [Cod_Producto], [Precio]) VALUES (@Nom" +
                "bre_Producto, @Cod_Producto, @Precio);\r\nSELECT Nombre_Producto, Cod_Producto, Pr" +
                "ecio FROM Producto WHERE (Cod_Producto = @Cod_Producto)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Producto] SET [Nombre_Producto] = @Nombre_Producto, [Cod_Producto] = @Cod_Producto, [Precio] = @Precio WHERE (((@IsNull_Nombre_Producto = 1 AND [Nombre_Producto] IS NULL) OR ([Nombre_Producto] = @Original_Nombre_Producto)) AND ([Cod_Producto] = @Original_Cod_Producto) AND ((@IsNull_Precio = 1 AND [Precio] IS NULL) OR ([Precio] = @Original_Precio)));
SELECT Nombre_Producto, Cod_Producto, Precio FROM Producto WHERE (Cod_Producto = @Cod_Producto)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        Nombre_Producto, Cod_Producto, Precio\r\nFROM            Producto";
        ...
        public virtual int Fill(Home.ProductoDataTable dataTable) {
        ...
        public virtual Home.ProductoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Home.ProductoDataTable dataTable = new Home.ProductoDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Home.ProductoDataTable dataTable) {
        ...
        public virtual int Delete(string Original_Nombre_Producto, int Original_Cod_Producto, global::System.Nullable<decimal> Original_Precio) {
            ...
            this.Adapter.DeleteCommand.Parameters[2].Value = ((int)(Original_Cod_Producto));
        ...
        public virtual int Insert(string Nombre_Producto, int Cod_Producto, global::System.Nullable<decimal> Precio) {
        ...
        public virtual int Update(string Nombre_Producto, int Cod_Producto, global::System.Nullable<decimal> Precio, string Original_Nombre_Producto, int Original_Cod_Producto, global::System.Nullable<decimal> Original_Precio) {
            if ((Nombre_Producto == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(Cod_Producto));
            if ((Precio.HasValue == true)) {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(Original_Cod_Producto));
            if ((Original_Precio.HasValue == true)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre_Producto, global::System.Nullable<decimal> Precio, string Original_Nombre_Producto, int Original_Cod_Producto, global::System.Nullable<decimal> Original_Precio) {
            return this.Update(Nombre_Producto, Original_Cod_Producto, Precio, Original_Nombre_Producto, Original_Cod_Producto, Original_Precio);
        }
    }
